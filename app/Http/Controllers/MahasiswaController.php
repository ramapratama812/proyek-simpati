...
class MahasiswaController extends Controller
{
    ...
    // ========================================================
    // 📘 SHOW — detail profil mahasiswa (akses admin/dosen)
    // ========================================================
    ...
    // ========================================================
    // ✏️ EDIT & UPDATE PROFIL MAHASISWA LOGIN
    // ========================================================
    ...
    public function updateProfile(Request $request)
    {
        ...
        // Refresh session agar data terbaru langsung tampil
        auth()->user()->refresh();
