...
class PddiktiFeederClient
{
    ...
    public function listDosen(int $limit=100, int $offset=0)
    {
        return $this->call('GetListDosen', compact('limit','offset'));
    }

    public function listMahasiswa(int $limit=100, int $offset=0)
    {
        return $this->call('GetStatusMahasiswa', compact('limit','offset'));
    }
}
