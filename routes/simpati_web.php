...
// BARIS INI ADALAH TAMBAHAN/MODIFIKASI:
// Asumsikan Anda memiliki Controller baru untuk menangani integrasi spesifik ini
...
.
    // ==================================================
    Route::get('/google/complete', [GoogleIntegrationController::class, 'complete'])
    ...
    // 🔹 Mahasiswa
    // ==================================================
    // Route::get('/mahasiswa', [DashboardController::class, 'students'])->name('mahasiswa.index'); // Duplicate definition
