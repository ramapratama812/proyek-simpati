...
<div class="container py-5">
    <div class="card border-0 shadow-lg rounded-4 overflow-hidden" style="max-width: 1200px; margin: 0 auto;">
        ...
        <div class="card-header text-center text-white py-4"
            ...
            <h2 class="fw-bold mb-0">Biodata Mahasiswa</h2>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                   ...
                   <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-dark mb-0">{{ $mahasiswa->nim ?? '-' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-dark mb-0">{{ $mahasiswa->jenis_kelamin ?? '-' }}</p>
                    </div>

                    <div class="mb-3">
                        <p class="text-muted mb-1">Semester</p>
                        <p class="text-dark mb-0">{{ $mahasiswa->semester ?? '-' }}</p>
                    </div>

                    <div class="mb-3">
                        <p class="text-muted mb-1">Status Aktivitas</p>
                        @if(strtolower($mahasiswa->status_aktivitas ?? '') == 'aktif')
                            <span class="status-badge bg-success">Aktif</span>
                        @elseif(strtolower($mahasiswa->status_aktivitas ?? '') == 'cuti')
...
{{-- STYLE TAMBAHAN --}}
<style>
    body { background-color: #f3f4ff; font-family: 'Poppins', sans-serif; }

    .card { border-radius: 1.5rem !important; }

    .text-muted { font-size: 0.9rem; color: #6b7280 !important; }
    ...
    .bg-warning { background-color: #facc15 !important; color: #000 !important; }
