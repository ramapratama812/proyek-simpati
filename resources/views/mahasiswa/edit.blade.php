...
<div class="container py-4">
    ...
    {{-- Main Card --}}
    {{-- ❗ LEBAR MAKSIMUM SAMA DENGAN DOSEN (1100PX) ❗ --}}
        ...
        <form action="{{ route('mahasiswa.update', $mahasiswa->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body p-5"> 
                ...
                <div class="col-12 text-center mb-4 pt-2">
                    <img src="{{ $mahasiswa->user->foto 
                            ? asset($mahasiswa->user->foto) 
                ...
                <div class="row g-4"> 
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="semester" class="form-control input-fancy"
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="status_aktivitas" class="form-select input-fancy">
                            ...
                            <option value="Lulus" {{ old('status_aktivitas', $mahasiswa->status_aktivitas) == 'Lulus' ? 'selected' : '' }}>Lulus</option>
                            <option value="Non-Aktif" {{ old('status_aktivitas', $mahasiswa->status_aktivitas) == 'Non-Aktif' ? 'selected' : '' }}>Non-Aktif</option>
                            <option value="Keluar" {{ old('status_aktivitas', $mahasiswa->status_aktivitas) == 'Keluar' ? 'selected' : '' }}>Keluar (DO)</option>
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        @error('program_studi')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        @error('perguruan_tinggi')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
                    </div>
            ...
            <div class="d-flex justify-content-between pt-4 pb-4 px-5 border-top footer-button-area">
                <a href="{{ route('mahasiswa.index') }}" class="btn btn-secondary-custom rounded-pill btn-smooth-action">
