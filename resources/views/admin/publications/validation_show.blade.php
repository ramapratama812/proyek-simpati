                ...
                <div class="d-flex justify-content-between align-items-start mb-2">
                    <div>
                        ...
                        <div class="small mb-1">
                            ...
                            @php
                                ...
                                if ($publication->volume) {
                                    $info[] = "Vol {$publication->volume}";
                                }
                                if ($publication->nomor) {
                                    $info[] = "No {$publication->nomor}";
                                }
                                if ($publication->tahun) {
                                    $info[] = "({$publication->tahun})";
                                }
                        ...
                        <div class="mt-2">
                            ...
                            @else
                                <span class="text-muted ms-1">Tidak ada file.</span>
                            @endif
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="btn-group" role="group" aria-label="Status publikasi">
                                ...
                                <input type="radio" class="btn-check" name="validation_status" id="status-approved"
                                    autocomplete="off" value="approved" @checked(old('validation_status', $publication->validation_status) === 'approved')>
                                ...
                                <input type="radio" class="btn-check" name="validation_status" id="status-revision"
                                    autocomplete="off" value="revision_requested" @checked(old('validation_status', $publication->validation_status) === 'revision_requested')>
                                ...
                                <input type="radio" class="btn-check" name="validation_status" id="status-rejected"
                                    autocomplete="off" value="rejected" @checked(old('validation_status', $publication->validation_status) === 'rejected')>
