...
:root {
    ...
    --text-color: #333;
    --divider-color: #c7d2e0; /* Warna untuk pemisah yang lebih jelas */
}
...
.section-title-custom {
    ...
    font-size: 1.5rem; 
    margin-bottom: 1.5rem !important; /* Jarak yang konsisten */
...
.form-label-custom {
    font-weight: 600;
    color: var(--primary-dark); /* Label lebih jelas */
    display: block;
...
.section-divider-bold {
    border: 0;
    height: 3px; /* Ditebalkan agar lebih jelas */
...
.footer-button-area {
    ...
    border-top: 1px solid var(--divider-color) !important; /* Batas atas button footer diperjelas */
    background: #fcfcfc;
}
