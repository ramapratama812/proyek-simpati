                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="card bg-light border-0">
                                        <div class="card-body">
                                            <!-- Local Upload -->
                                            <div class="mb-2">
                                                <label class="form-label small text-muted fw-bold mb-1">Unggah File
                                                    (PDF)</label>
                                                <input type="file" name="surat_proposal" id="inputLocalProposal"
                                                    accept="application/pdf" class="form-control" required>
                                            </div>

                                            <div class="text-center my-3 position-relative">
                                                <hr class="m-0 border-secondary" style="opacity: 0.1;">
                                                <span
                                                    class="position-absolute top-50 start-50 translate-middle bg-light px-2 text-muted small fw-bold">ATAU</span>
                                            </div>
                                            ...
                                            <div class="mb-0">
                                                <label class="form-label small text-muted fw-bold mb-1">Ambil dari
                                                    Google Drive</label>
                                                <input type="hidden" name="gdrive_pdf_proposal_json"
                                                    id="gdrive_pdf_proposal_json"
                                    ...
                                    <div class="form-text small mt-1"><i class="bi bi-info-circle me-1"></i>Wajib
                                        melampirkan proposal (PDF) baik melalui unggah langsung atau Google Drive.</div>
                                </div>
                                <div class="mb-3">
