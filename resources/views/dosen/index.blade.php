...
<div class="container-fluid py-4">
    ...
    {{-- Header Biru Tua Polos --}}
    <div class="header-box text-center text-white fw-bold mb-4 py-3 rounded-4 shadow-lg">
       Daftar Dosen
    </div>

    {{-- Search Bar --}}
    <form action="{{ route('dosen.index') }}" method="GET" class="mb-4 mx-auto" style="max-width: 480px;">
    ...
    <div class="table-responsive">
        <table class="table align-middle table-borderless shadow-sm">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="4" class="text-center text-muted py-4">Tidak ada dosen ditemukan.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
...
/* ===== Header Biru Tua Polos ===== */
.header-box {
    background: #002b6d; /* 🔹 Biru tua solid */
    font-size: 1.4rem;
