        ...
        <div class="card-body px-4 px-md-5 py-5" style="background-color: #fbfbff;">
            ...
            <ul class="nav nav-tabs custom-tabs mb-4" id="dosenTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="kegiatan-tab" data-bs-toggle="tab" data-bs-target="#kegiatan" type="button" role="tab" aria-controls="kegiatan" aria-selected="true">
                        <i class="bi bi-person-workspace me-1 text-warning"></i> Kegiatan ({{ count($dosen->kegiatanDiketuai ?? []) + count($dosen->anggotaProyek ?? []) }})
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="publikasi-tab" data-bs-toggle="tab" data-bs-target="#publikasi" type="button" role="tab" aria-controls="publikasi" aria-selected="false">
                        <i class="bi bi-journal-text me-1 text-danger"></i> Publikasi ({{ $dosen->publikasi->count() }})
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pddikti-tab" data-bs-toggle="tab" data-bs-target="#pddikti" type="button" role="tab" aria-controls="pddikti" aria-selected="false">
...
.pddikti-btn, .edit-btn-smooth {
    transition: all 0.3s ease;
}
.pddikti-btn:hover, .edit-btn-smooth:hover {
