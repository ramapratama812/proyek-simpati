...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .sidebar {
      width: 270px;
      background: linear-gradient(180deg, #003366 0%, #001F54 100%);
      padding: 35px 24px;
      color: #fff;
      display: flex;
    ...
    .sidebar a.active::before {
      ...
      height: 100%;
      width: 4px;
      background: linear-gradient(180deg, #00bfff, #0096ff);
...
<body>
  {{-- 🔹 Cek jika bukan halaman login/register baru tampilkan sidebar & navbar --}}
  ...
  @else
    {{-- 🔹 Jika halaman login/register, tampilkan konten saja --}}
    <main>
      @yield('content')
    </main>
  @endif
